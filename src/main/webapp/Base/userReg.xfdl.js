(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button02","520","121","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("중복확인");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("idValid","615","126","295","20",null,null,null,null,null,null,this);
            obj.set_taborder("43");
            obj.set_visible("false");
            obj.set_color("crimson");
            obj.set_text("아이디는 6~12자 숫자, 영문 조합으로 작성해주세요.");
            this.addChild(obj.name, obj);

            obj = new Static("idChkFail","615","126","165","20",null,null,null,null,null,null,this);
            obj.set_taborder("44");
            obj.set_visible("false");
            obj.set_color("crimson");
            obj.set_text("다른 아이디를 사용해주세요.");
            this.addChild(obj.name, obj);

            obj = new Static("idChkPass","615","126","205","20",null,null,null,null,null,null,this);
            obj.set_taborder("45");
            obj.set_visible("false");
            obj.set_color("forestgreen");
            obj.set_text("사용가능한 아이디입니다.");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("idChkValid","615","126","295","20",null,null,null,null,null,null,this);
            obj.set_taborder("53");
            obj.set_visible("false");
            obj.set_color("crimson");
            obj.set_text("중복검사를 실시해주세요.");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("userReg.xfdl", function() {
        ...
        this.userId_onkeyup = function(obj,e)
        {
        	if(this.userId.value == "" || this.userId.value == null){
        		this.idChkValid.set_visible(false);
        		this.idChkPass.set_visible(false);
        ...
        this.loadIncludeScript("userReg.xfdl");
